...
export const Repository: React.FC = (props) => {
  ...
  const [Issue, setIssues] = React.useState<GithubIssue[]>([])
  ...
  React.useEffect( () => {
      ...
      api
        ...
        // api vai retornar o GitHubIssues e vai retornar para variavel

      api
      .get<GithubIssue[]>(`repos/${params.repository}/issue`)
