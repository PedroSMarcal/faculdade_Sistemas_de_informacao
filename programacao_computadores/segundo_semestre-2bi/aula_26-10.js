...
// class
class carro {
    //metodo construtor = inicializa as var da classe 
    constructor(marca, modelo, ano, velocidade, motor){
        this.marca = marca
        this.modelo = modelo
        this.ano = ano
        this.velocidade = velocidade
        this.motor = motor // motor true(ligado), false(desligado)
    }

    mostrar(){
        console.log(this)
    }
    // fazer uma função para aumentar a velocidade do carro em x unidades
    aumentar(x){
        if(this.motor == true){
...
//vamos instanciar o objetos da classe
// this representa o obj 1 
let obj1 = new carro("GM", "Onyx", 2019, 0, false)
obj1.mostrar()
// this representa o obj 2 
let obj2 = new carro("Fiat", "Palio", 2020, 0, false)
obj2.mostrar()

//aumentar velocidade
let x
x = Number(prompt('Informe-nos a velocidade a ser inserida no carro'))
obj1.aumentar(x)

x = Number(prompt(`Informe-nos a velocidade a ser inserida no objeto 2 `))
obj2.aumentar(x)

x = Number(prompt('Informe-nos a velocidade a ser diminuida'))
obj1.diminuir(y)
